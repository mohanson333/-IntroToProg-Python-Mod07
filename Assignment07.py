# ---------------------------------------------------------------------------- #
# Title: Assignment 07
# Description: Storing data into a binary file, pickling
# ChangeLog (Who,When,What):
# Monica Hanson,8.23.2022, Created script
# Monica Hanson,8.24.2022, Continued script
# ---------------------------------------------------------------------------- #
...
file_name_str = "Todo.dat"  # The name of the data file
...
class Processor:
    ...
    def pickle_data_to_file(file_name, list_of_rows):
        """ Pickles the data from a list of rows to a File
...
Processor.load_data_from_file(file_name=file_name_str, list_of_rows=table_lst) # read file data
